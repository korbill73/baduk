...
time.sleep(2)
channel.send("/root/katago-env/bin/katago version; /root/katago-env/bin/katago check -model /root/katago-bin/model.bin.gz -config /root/katago-bin/analysis_config.cfg\n")
time.sleep(5)
output = ""
